...
import zoo.advanced.AltMetafactoryBoundaryCase;
import zoo.advanced.ComplexFinallyBoundaryCase;
import zoo.advanced.ConstructorBoundaryAdvancedCase;
import zoo.advanced.EligibilityAdvancedCase;
...
import zoo.advanced.MethodHandleBoundaryMatrixCase;
import zoo.advanced.ReflectionAdvancedCase;
import zoo.advanced.ThreadBoundaryMatrixCase;
import zoo.advanced.ThreadMonitorAdvancedCase;
import zoo.advanced.UnsafeVarHandleAdvancedCase;
import zoo.advanced.UnsafeRawMemoryBoundaryCase;
import zoo.advanced.VarHandleBoundaryMatrixCase;
import zoo.basic.ArrayBasicCase;
import zoo.basic.ArrayEdgeBasicCase;
import zoo.basic.ControlFlowBasicCase;
import zoo.basic.ExceptionBasicCase;
import zoo.basic.InterfaceLambdaConcatBasicCase;
import zoo.basic.MonitorExceptionBasicCase;
import zoo.basic.NumericConversionBasicCase;
...
import zoo.basic.ReferenceIdentityBasicCase;
import zoo.basic.ReflectionBasicCase;
import zoo.basic.ReflectionFieldBasicCase;
...
public final class Main {
    ...
    private static List<Case> basicCases() {
        ...
        cases.add(new NumericConversionBasicCase());
        cases.add(new ArrayBasicCase());
        cases.add(new ArrayEdgeBasicCase());
        cases.add(new ControlFlowBasicCase());
        cases.add(new ExceptionBasicCase());
        cases.add(new ObjectBasicCase());
        cases.add(new ReferenceIdentityBasicCase());
        cases.add(new MonitorExceptionBasicCase());
        ...
        cases.add(new ReflectionFieldBasicCase());
    ...
    private static List<Case> advancedCases() {
        ...
        cases.add(new MethodHandleBoundaryMatrixCase());
        cases.add(new AltMetafactoryBoundaryCase());
        cases.add(new UnsafeVarHandleAdvancedCase());
        cases.add(new UnsafeRawMemoryBoundaryCase());
        cases.add(new VarHandleBoundaryMatrixCase());
        cases.add(new ThreadMonitorAdvancedCase());
        cases.add(new ThreadBoundaryMatrixCase());
        cases.add(new InterfaceBoundaryAdvancedCase());
        cases.add(new ComplexFinallyBoundaryCase());
        cases.add(new ConstructorBoundaryAdvancedCase());
        cases.add(new EligibilityAdvancedCase());
