    ...
    static List<JdkIntrinsic> policies() {
        return List.of(
                ...
                bridge(
                        ...
                        "class-relative resource stream lookup"),
                bridge("java/io/InputStream", "close", "()V", "input-stream close"),
                bridge("java/io/InputStream", "readAllBytes", "()[B", "input-stream bulk read"),
                ...
                bridge("java/lang/Throwable", "addSuppressed", "(Ljava/lang/Throwable;)V", "Throwable suppression update"),
                bridge(
                        "java/lang/invoke/MethodHandles",
                        "privateLookupIn",
                        "(Ljava/lang/Class;Ljava/lang/invoke/MethodHandles$Lookup;)Ljava/lang/invoke/MethodHandles$Lookup;",
                        "private lookup creation"),
                bridge(
                ...
                bridge("java/nio/ByteBuffer", "get", "()B", "JVM buffer byte read"),
                bridge("java/nio/ByteBuffer", "get", "([B)Ljava/nio/ByteBuffer;", "JVM buffer bulk read"),
                bridge("java/nio/ByteBuffer", "putInt", "(I)Ljava/nio/ByteBuffer;", "JVM buffer mutation"),
                bridge("java/nio/ByteBuffer", "remaining", "()I", "JVM buffer remaining-byte lookup"),
                bridge("java/nio/ByteBuffer", "wrap", "([B)Ljava/nio/ByteBuffer;", "JVM buffer wrapping"),
                ...
                bridge("java/util/Arrays", "fill", "([BB)V", "byte-array fill"),
