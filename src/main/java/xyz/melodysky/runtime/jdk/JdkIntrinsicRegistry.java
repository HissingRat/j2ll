...
public final class JdkIntrinsicRegistry {
    ...
    public static JdkIntrinsicRegistry defaultRegistry() {
        ArrayList<JdkIntrinsic> methods = new ArrayList<>(List.of(
                ...
                JdkIntrinsic.bridge("java/lang/Runnable", "run", "()V", "JDK_BRIDGE: Runnable.run uses JVM interface dispatch semantics"),
                JdkIntrinsic.bridge("java/util/ArrayList", "<init>", "()V", "JDK_BRIDGE: ArrayList construction stays on the JVM"),
                JdkIntrinsic.unsupported("java/util/ArrayList", "add", "(Ljava/lang/Object;)Z", "JDK_COLLECTION_HELPER_UNSUPPORTED: ArrayList.add uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/ArrayList", "get", "(I)Ljava/lang/Object;", "JDK_COLLECTION_HELPER_UNSUPPORTED: ArrayList.get uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/ArrayList", "size", "()I", "JDK_COLLECTION_HELPER_UNSUPPORTED: ArrayList.size uses JVM collection semantics"),
                JdkIntrinsic.bridge("java/util/HashMap", "<init>", "()V", "JDK_BRIDGE: HashMap construction stays on the JVM"),
                JdkIntrinsic.unsupported("java/util/HashMap", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "JDK_COLLECTION_HELPER_UNSUPPORTED: HashMap.put uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/HashMap", "get", "(Ljava/lang/Object;)Ljava/lang/Object;", "JDK_COLLECTION_HELPER_UNSUPPORTED: HashMap.get uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/HashMap", "containsKey", "(Ljava/lang/Object;)Z", "JDK_COLLECTION_HELPER_UNSUPPORTED: HashMap.containsKey uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/Arrays", "copyOf", "([II)[I", "JDK_ARRAYS_HELPER_UNSUPPORTED: Arrays.copyOf uses JVM array semantics"),
                JdkIntrinsic.bridge("java/util/Arrays", "equals", "([I[I)Z", "JDK_BRIDGE: Arrays.equals uses JVM array semantics"),
                JdkIntrinsic.unsupported("java/util/Arrays", "fill", "([IIII)V", "JDK_ARRAYS_HELPER_UNSUPPORTED: Arrays.fill uses JVM array semantics"),
                JdkIntrinsic.unsupported("java/util/Arrays", "asList", "([Ljava/lang/Object;)Ljava/util/List;", "JDK_COLLECTION_HELPER_UNSUPPORTED: Arrays.asList uses JVM list semantics"),
                JdkIntrinsic.unsupported("java/util/Collections", "emptyList", "()Ljava/util/List;", "JDK_COLLECTION_HELPER_UNSUPPORTED: Collections.emptyList uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/Collections", "singletonList", "(Ljava/lang/Object;)Ljava/util/List;", "JDK_COLLECTION_HELPER_UNSUPPORTED: Collections.singletonList uses JVM collection semantics"),
                JdkIntrinsic.unsupported("java/util/Optional", "of", "(Ljava/lang/Object;)Ljava/util/Optional;", "JDK_OPTIONAL_HELPER_UNSUPPORTED: Optional.of uses JVM Optional semantics"),
                JdkIntrinsic.unsupported("java/util/Optional", "ofNullable", "(Ljava/lang/Object;)Ljava/util/Optional;", "JDK_OPTIONAL_HELPER_UNSUPPORTED: Optional.ofNullable uses JVM Optional semantics"),
                JdkIntrinsic.unsupported("java/util/Optional", "isPresent", "()Z", "JDK_OPTIONAL_HELPER_UNSUPPORTED: Optional.isPresent uses JVM Optional semantics"),
                JdkIntrinsic.unsupported("java/util/Optional", "get", "()Ljava/lang/Object;", "JDK_OPTIONAL_HELPER_UNSUPPORTED: Optional.get uses JVM Optional semantics"),
                JdkIntrinsic.unsupported("java/util/Optional", "orElse", "(Ljava/lang/Object;)Ljava/lang/Object;", "JDK_OPTIONAL_HELPER_UNSUPPORTED: Optional.orElse uses JVM Optional semantics"),
                JdkIntrinsic.unsupported("java/lang/String", "format", "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;", "JDK_FORMAT_HELPER_UNSUPPORTED: String.format uses JVM formatter semantics"),
                ...
                JdkIntrinsic.bridge("java/lang/IllegalStateException", "<init>", "(Ljava/lang/String;)V", "JDK_BRIDGE: IllegalStateException(String) keeps JVM Throwable semantics"),
                ...
                JdkIntrinsic.unsupported(
                        ...
                        "substring",
                        "(I)Ljava/lang/String;",
                        "single-index substring is outside the current native-lowering boundary")));
