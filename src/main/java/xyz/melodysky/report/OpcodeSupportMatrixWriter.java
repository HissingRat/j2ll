...
public final class OpcodeSupportMatrixWriter {
    ...
    public List<OpcodeSupportEntry> defaultEntries() {
        return List.of(
                ...
                entry("invokevirtual Object.getClass()Ljava/lang/Class;", "invoke", "HELPER_BACKED", "JDK_INTRINSIC_HELPER", "ObjectGetClassNativeHelperTest"),
                entry("invokestatic Thread.sleep(J)V", "invoke", "HELPER_BACKED", "THREAD_HELPER", "ThreadSleepNativeHelperTest"),
                ...
                entry("try/catch/finally with validated handler frames", "exception", "HELPER_BACKED", "JVM_PENDING_EXCEPTION_ORDERED_DISPATCH", "ProtectedJvmExceptionFlowNativeRuntimeE2eTest"),
                entry("handler frame/locals mismatch", "exception", "SKIPPED", "UNSUPPORTED_EXCEPTION_STATE_MERGE", "KnownBlockersWriterTest"),
